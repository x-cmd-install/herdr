...
合计: **624,520** 行代码（覆盖前 5 种语言、共 **1236** 个文件）。
...
- **Star**: 37,467 · **Fork**: 2,757 · **开放 issue**: 1,899 · **贡献者**: 83

## 累计统计

- **发布数**: 86 · **已合并 PR**: 325 · **开放 PR**: 37 · **已关闭 issue**: 1608 · **开放 issue**: 291 · **提交数**: 1574
...
在 [repology.org](https://repology.org/project/herdr) 上共有 **11** 个发行版报告此项目。**4** 个 ✅ 已是最新上游版本，**5** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T22:22:50Z._
