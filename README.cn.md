...
合计: **624,718** 行代码（覆盖前 5 种语言、共 **1236** 个文件）。
...
- **Star**: 37,541 · **Fork**: 2,771 · **开放 issue**: 1,904 · **贡献者**: 83

## 累计统计

- **发布数**: 86 · **已合并 PR**: 327 · **开放 PR**: 36 · **已关闭 issue**: 1611 · **开放 issue**: 293 · **提交数**: 1576
...
在 [repology.org](https://repology.org/project/herdr) 上共有 **12** 个发行版报告此项目。**4** 个 ✅ 已是最新上游版本，**6** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T05:09:51Z._
